...
def set_velocityy(velocityy): 
    RightBase.set_velocity(velocityy, PERCENT)
    LeftBase.set_velocity(velocityy, PERCENT)
...
def Part2(): 
    ...
    leftTurn(95)
    set_velocityy(100)
    driveMM(599.32)   # 599.32 = 283 MM
    rightTurn(30)
    driveMM(156.52)   # 156.52 = 100 MM
    leftTurn(115)
    '''RightBase.set_velocity(100, PERCENT)
    LeftBase.set_velocity(100, PERCENT)
    driveMM(255)
    ...
    #wait(0.5)
    #rightTurn2(1)
    Drivebase_Reverse2(1.9)
    WaitTime(0.1)
    if RightBase.is_spinning() == False: 
        leftTurn2(0.75)
        Drivebase_Reverse2(0.45)
        rightTurn2(0.75)
        Drivebase_Reverse2(1)
        Bluetower.spin(REVERSE)
        WaitTime(0.1)
        Drivebase_Reverse2(2.5)
    #leftTurn2(1)
    #part not needed
    LeftBase.stop()
    RightBase.stop()
